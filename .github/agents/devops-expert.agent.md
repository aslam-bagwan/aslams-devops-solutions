...
tools: ['search/codebase', 'search/changes', 'edit/editFiles', 'search', 'execute/createAndRunTask', 'execute/getTerminalOutput', 'execute/runInTerminal', 'execute/testFailure', 'agent', 'vscode/askQuestions', 'read/terminalSelection', 'read/terminalLastCommand']
---
